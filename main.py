...
with open(r'C:\Users\Admin\Desktop\STREAMLIT\rfr.pkl' ,'rb') as file:
    rfr = pickle.load(file)

rfc = joblib.load(r'C:\Users\Admin\Desktop\STREAMLIT\rfc.joblib')

df_ad = pd.read_csv(r'C:\Users\Admin\Desktop\STREAMLIT\Advertising.csv')
df_db = pd.read_csv(r'C:\Users\Admin\Desktop\STREAMLIT\diabetes2.csv')
